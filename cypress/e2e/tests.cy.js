...
describe('Dzemat management app', () => {
  ...
  it.only('DP-11 Add "mualima" in module "Mekteb" on Džemat MGMT dev env', () => {
    const randomName = faker.person.firstName()
    const randomLastName = faker.person.lastName()
    const randomID = faker.finance.accountNumber()
    const randomMiddleName = faker.person.middleName()
    ...
    //ovdje nisam sigurna kako izaci iz ove pod-forme da bih se vratila na module na sidebar
  })
